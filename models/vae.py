...
class VAE(nn.Module):
    def __init__(self,  input_size, hidden_neurons, hidden_activation, dropout_rate, output_activation,):
        ...
        self.decoder = Decoder(input_size, hidden_neurons, hidden_activation, dropout_rate, output_activation)
...
class Vae(BaseDetector):
    ...
    def _build_model(self):
        return VAE(self.n_features_ * self.n_samples_ ,  self.hidden_neurons_ , self.hidden_activation , self.dropout_rate, self.output_activation)
